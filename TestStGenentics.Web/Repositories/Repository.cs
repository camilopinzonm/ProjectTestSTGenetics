...
namespace TestStGenentics.Web.Repositories
{
    public class Repository : IRepository
    {
        ...
        public async Task<HttpResponseWrapper<object>> PostGetRows<T>(string url, T model)
        {
        ...
        public async Task<HttpResponseWrapper<TResponse>> PostGetRows<T, TResponse>(string url, T model)
        {
